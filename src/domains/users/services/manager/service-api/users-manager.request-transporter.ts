...
import { UsersManagerRequestTopics } from './users-manager.request-topics';
import {
  CreateUserV1Request,
...
@Injectable()
export class UsersManagerRequestTransporter {
  public constructor(
    @Inject(USERS_MANAGER_TRANSPORTER_TOKEN)
  ...
  public async createUserV1(
    ...
    return this.transport.sendRequest<
      CreateUserV1Request,
      CreateUserV1Response
    >(UsersManagerRequestTopics.createUserV1, request, context);
  }
  ...
  public async readUserV1(
    ...
    return this.transport.sendRequest<
      ReadUserV1Request,
      ReadUserV1Response
    >(UsersManagerRequestTopics.readUserV1, request, context);
  }
  ...
  public async readUserByEmailV1(
    ...
    return this.transport.sendRequest<
      ReadUserByEmailV1Request,
      ReadUserByEmailV1Response
    >(UsersManagerRequestTopics.readUserByEmailV1, request, context);
  }
}